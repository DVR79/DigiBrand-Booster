...
export const metadata: Metadata = {
  ...
  description: 'Senior-led performance marketing agency in Bangalore. SEO, Meta Ads, Google Ads, plus AEO and GEO to get cited in AI answers. For D2C, SaaS and EdTech.',
  keywords: [
  ...
  openGraph: {
    ...
    images: [{ url: `${SITE_URL}/og-image.png`, width: 1200, height: 630, type: 'image/png', alt: 'Digi Brand Booster: Performance Marketing Agency India' }],
  },
  twitter: {
