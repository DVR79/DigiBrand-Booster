    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          ...
          style={{ background: '#1a1a2e', border: '1px solid rgba(255,255,255,0.12)', boxShadow: '0 8px 32px rgba(0,0,0,0.5)', minWidth: '180px' }}
        >
          <a
          ...
          <a
            ...
            onClick={() => setOpen(false)}
          >
            <svg viewBox="0 0 24 24" fill="#25D366" width="15" height="15" aria-hidden="true">
