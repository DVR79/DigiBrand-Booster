...
export default function Contact() {
  ...
  useEffect(() => {
    ...
    function handleEscape(e: KeyboardEvent) {
      if (e.key === 'Escape') setShowContactPopup(false);
    }
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!form.message.trim()) { setError('Please describe your biggest growth challenge.'); setLoading(false); return; }

    // Guard: abort if EmailJS credentials are missing
    if (!EMAILJS_SERVICE_ID || !EMAILJS_TEMPLATE_ID || !EMAILJS_PUBLIC_KEY) {
      setError('Contact form is not configured. Please reach out via WhatsApp or email directly.');
      setLoading(false);
      return;
    }
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <div className="relative" ref={popupRef}>
                ...
                >
                  <Phone size={13} aria-hidden="true" /> Contact Us
                </button>
                ...
                {showContactPopup && (
                  <div
                    ...
                    style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', boxShadow: '0 8px 32px rgba(0,0,0,0.3)', minWidth: '180px' }}
                  >
                    <a
                    ...
                    >
                      <Phone size={15} style={{ color: 'var(--accent-primary)' }} aria-hidden="true" />
                      Call Us
                    </a>
                    ...
                    <a
                      ...
                      onClick={() => setShowContactPopup(false)}
                    >
                      <svg viewBox="0 0 24 24" fill="currentColor" width="15" height="15" style={{ color: '#25D366' }} aria-hidden="true">
