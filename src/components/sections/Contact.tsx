...
import { Mail, MapPin, Phone, Globe, CheckCircle, ArrowRight } from 'lucide-react';
...
export default function Contact() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const messageText = [
      `New Audit Request — digibrandbooster.tech`,
      ``,
      `Name: ${form.name}`,
      `Email: ${form.email}`,
      ...
      await fetch('https://api.emailjs.com/api/v1.0/email/send', {
        ...
        body: JSON.stringify({
          ...
          template_params: {
            ...
            email: form.email,
            subject: `New Audit Request — digibrandbooster.tech`,
            title: `New Audit Request — digibrandbooster.tech`,
    ...
    const waUrl = `https://wa.me/${siteConfig.whatsapp}?text=${encodeURIComponent(messageText)}`;
    setLoading(false);
    setSubmitted(true);
        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-10 items-start">
          ...
          >
            ...
            <div className="space-y-3 mb-7">
              {contactInfo.map((item) => (
                <a
                  ...
                  className="flex items-start gap-3 p-3.5 rounded-xl transition-colors group"
            ...
            <div className="flex flex-wrap gap-2">
              {[
                { label: 'LinkedIn', href: 'https://www.linkedin.com/company/digibrandbooster' },
