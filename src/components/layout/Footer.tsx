              ...
              {socialLinks.map((s) => (
                <a
                  ...
                  style={{
                    ...
                    color: s.href === '#' ? 'rgba(255,255,255,0.25)' : 'rgba(255,255,255,0.6)',
                    cursor: s.href === '#' ? 'default' : 'pointer',
                  }}
                  onMouseEnter={(e) => {
                    if (s.href === '#') return;
                  ...
                  onMouseLeave={(e) => {
                    ...
                    (e.currentTarget as HTMLAnchorElement).style.color = s.href === '#' ? 'rgba(255,255,255,0.25)' : 'rgba(255,255,255,0.6)';
