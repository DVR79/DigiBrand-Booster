...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <a href="/" title="Digi Brand Booster - Home" className="flex items-center">
            <Image src="/logo.svg" alt="Digi Brand Booster" width={250} height={35} className="w-[180px] sm:w-[250px] h-auto" priority />
          </a>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              className="md:hidden p-3.5 min-w-[44px] min-h-[44px] rounded-lg"
      ...
      {menuOpen && (
        <div id="mobile-nav" style={{ background: NAV_BG, borderTop: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 8px 24px rgba(0,0,0,0.3)' }}>
